                        ...
                        <div className="flex justify-center mb-6">
                            <div className="inline-flex bg-white rounded-xl p-1.5 shadow-lg border-2 border-gray-200">
                                <button
                                    ...
                                    className={`px-6 py-3 rounded-lg font-semibold text-sm transition-all ${activeTab === 'hiring'
                                ...
                                <button
                                    ...
                                    className={`px-6 py-3 rounded-lg font-semibold text-sm transition-all ${activeTab === 'college'
                                        ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-md'
                                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`px-6 py-3 rounded-lg font-semibold text-sm transition-all ${activeTab === 'featured'
                                        ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-md'
                                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                        }`}
                                >
