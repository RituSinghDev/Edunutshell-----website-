        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {!submitted ? (
            <>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6 mb-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-slate-900 mb-2 text-lg">Verification Process</p>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-slate-900">Verification Form</h2>
            </div>
            ...
            <>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-8 mb-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-600">Thank you for submitting your verification request</p>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg border border-amber-200 p-6 mb-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-bold text-slate-900 mb-2 text-lg">Please Wait for Approval</p>
                    <p className="text-slate-600">
